...
MavlinkCommandSender::CommandLong
CameraImpl::make_command_track_point(float _pointx, float _pointy, float _radius)
{
    MavlinkCommandSender::CommandLong cmd{};
    // cmd_zoom_wide.target_system_id = MAV_COMP_ID_ALL;
    // cmd.target_system_id = MAV_COMP_ID_AUTOPILOT1;
...
MavlinkCommandSender::CommandLong CameraImpl::make_command_track_rectangle(
    float _top_left_x, float _top_left_y, float _bottom_right_x, float _bottom_right_y)
{
    MavlinkCommandSender::CommandLong cmd{};
    // cmd_zoom_wide.target_system_id = MAV_COMP_ID_ALL;
    // cmd.target_system_id = MAV_COMP_ID_AUTOPILOT1;
...
Camera::Result CameraImpl::camera_track_rectangle(
...
void CameraImpl::camera_zoom_wide_async(const Camera::ResultCallback& callback)
{
    ...
    _system_impl->send_command_async(cmd, [this, callback](MavlinkCommandSender::Result result, float) {
...
void CameraImpl::camera_track_point_async(
    float pointx, float pointy, float radius, const Camera::ResultCallback& callback)
{
    // Create by PannapatC.
...
void CameraImpl::camera_track_rectangle_async(
    float top_left_x,
    float top_left_y,
